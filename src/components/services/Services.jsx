    ...
    <div className='container services__container'>
        ...
        <article className='service'>
           ...
           <ul className='service__list'>
              ...
              <p>-Logging-in to the system page is maintained to restrict unauthorized persons from using important data.  entry.</p>
              ...
              <FaHandPointRight className='service__list-icon' size={15}/> 
                <p><b>Technology used</b> - OOPs are used to keep record and update the existing and new member entry</p>
              </li>
              
              <li>
              <FaHandPointRight className='service__list-icon' size={15}/> 
                <p><b>Other Technology used</b> -Tech Stack - OOPs , c++</p>
              </li>
